    ...
    <%
                    ...
                    <div class="dropdown">
                        ...
                        >
                            ...
                            <li>
                            <a class="dropdown-item" href="index.jsp?mail=<%=mail%>">Login</a>
                            </li>
                        </ul>
        ...
        <!--**********************************
            Profile Edit Start 
        ***********************************-->
       <form action="update_user_profile_quary.jsp?mail=<%=mail%>" method="post" >
            <div class="container">
   ...
   <%
				...
				%>
                        ...
                        <div class="p-3 py-5" >
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6"><label class="labels">Name</label><input type="text" name="name" class="form-control" placeholder="first name" value="<%=i.getString("name")%>"></div>
                                <div class="col-md-6"><label class="labels">Surname</label><input type="text" name="surname" class="form-control" value="<%=i.getString("surName")%>" placeholder="surname"></div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12"><label class="labels">Mobile Number</label><input type="text" name="phone" class="form-control" placeholder="enter phone number" value="<%=i.getString("mobileNumber")%>"></div>
                                <div class="col-md-12"><label class="labels">Address Line 1</label><input type="text" name="addressp" class="form-control" placeholder="enter address line 1" value="<%=i.getString("Addressp")%>"></div>
                                <div class="col-md-12"><label class="labels">Address Line 2</label><input type="text" name="addresss" class="form-control" placeholder="enter address line 2" value="<%=i.getString("addresss")%>"></div>
                                <div class="col-md-12"><label class="labels">Postcode</label><input type="text" name="postcode" class="form-control" placeholder="enter address line 2" value="<%=i.getString("postcode")%>"></div>
                                <div class="col-md-12"><label class="labels">State</label><input type="text" name="state" class="form-control" placeholder="enter address line 2" value="<%=i.getString("state")%>"></div>
                                <div class="col-md-12"><label class="labels">Area</label><input type="text" name="area" class="form-control" placeholder="enter address line 2" value="<%=i.getString("area")%>"></div>
                                <div class="col-md-12"><label class="labels">Email ID</label><input type="text" name="email" class="form-control" placeholder="enter email id" value="<%=i.getString("email")%>"></div>
                                
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6"><label class="labels">Country</label><input type="text" name="country" class="form-control" placeholder="country" value="<%=i.getString("country")%>"></div>
                                <div class="col-md-6"><label class="labels">State/Region</label><input type="text" name="region" class="form-control" value="<%=i.getString("region")%>" placeholder="state"></div>
                            </div>
