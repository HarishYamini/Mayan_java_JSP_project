...
<body>
	...
	<div class="bodya">
		<div class="backtotop" >
			<a href="socialmedia.jsp?mail=<%=mail%>" style="color: #ffac00;"><i class="fa-solid fa-angles-up"></i></a>
...
<!-- Container wrapper -->
		...
		<div class="banner">
				...
				<img src="Images/social.png" class="img-fluid" alt="HealthCare" style="margin: 0px 0px 0px 0px;width: 100%;">
				<div class="demo">
					<h1>demo page</h1><br>
					<h1>demo page</h1>
					<br>
	  ...
	  <div class="container text-center text-md-start mt-5">
		...
		<div class="row mt-3">
		  ...
		  <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
			...
			<p>
			  <a href="contact.jsp?mail=<%=mail%>" class="text-reset">About Us</a>
			</p>
			<p>
