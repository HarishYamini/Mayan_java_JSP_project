...
<section class="text-center text-lg-start">
  ...
  <div class="container py-4">
    <div class="row g-0 align-items-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="card cascading-right" style="
          ...
          <div class="card-body p-5 shadow-5 text-center">
            ...
            <form action="signupquary.jsp"  method="post">
              <!-- User name -->
              <div class="mb-3">
              ...
              <a href="index.jsp" class="btn">  Sign in</a>
            </form>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <img src="img/13-130289_robot-warm-up-android-humanoid-robot-hd-png.png" class="w-100 rounded-4 shadow-4"
          alt="" />
      </div>
    </div>
  </div>
