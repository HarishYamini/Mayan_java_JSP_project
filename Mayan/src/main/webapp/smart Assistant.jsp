...
<body>
	...
	<div class="bodya">
		<div class="backtotop" >
			<a href="smart Assistant.jsp?mail=<%=mail%>" style="color: #ffac00;"><i class="fa-solid fa-angles-up"></i></a>
...
<!-- Container wrapper -->
				...
				<img src="Images/smart.png" class="img-fluid" alt="HealthCare" style="margin: 0px 0px -20px 0px;">
				<div class="demo">
					<h1>demo page</h1>
					<br>
					<h1>demo page</h1>
