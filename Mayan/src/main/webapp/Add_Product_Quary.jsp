...
<body>
		...
		String a= "insert into admin_product(id,productName,productId,rate,discount,spec,detail,image) values (id,'"+productName+"','"+productId+"','"+rate+"','"+Discount+"','"+Spec+"','"+Detail+"','"+image+"')";
